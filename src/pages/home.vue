<template>
    <template v-if="homeData">
        ...
        <view class="flex gap-3 m-4 text-sm">
            <view class="h-20 b-10 center rounded-xl w-full bg-r gap-1" @click="teacherList('大学生教员')">
                <image class="w-5 h-5" src="@/static/home/大学生教员.png" />
                <view>大学生教员</view>
            </view>
            <view class="h-20 b-10 center rounded-xl w-full bg-r gap-1" @click="teacherList('研究生教员')">
                <image class="w-5 h-5" src="@/static/home/研究生教员.png" />
                <view>研究生教员</view>
            </view>
            <view class="h-20 b-10 center rounded-xl w-full bg-r gap-1" @click="teacherList('专业教员')">
                <image class="w-5 h-5" src="@/static/home/专业教员.png" />
                <view>专业教员</view>
            </view>
        </view>
    </template>
